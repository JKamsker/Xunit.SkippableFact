...
1. Push any NuGet packages in the `deployables` artifact to GitHub Packages.
1. If you have `NUGET_API_KEY` defined as a secret variable for your repo or org, any NuGet packages in the `deployables` artifact will also be pushed to nuget.org.
